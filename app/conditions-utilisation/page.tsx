        ...
        <div className="bg-white rounded-lg p-8 border border-border space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-foreground mb-2">Utilisation autorisée</h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-foreground mb-2">Utilisation interdite</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">4. Comptes utilisateurs</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">5. Commandes et paiements</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-foreground mb-2">Processus de commande</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
              ...
              <div>
                <h3 className="text-lg font-medium text-foreground mb-2">Paiement</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">6. Livraison</h2>
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">8. Garanties et responsabilité</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-foreground mb-2">Garantie produits</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
              ...
              <div>
                <h3 className="text-lg font-medium text-foreground mb-2">Limitation de responsabilité</h3>
                <p className="text-muted-foreground leading-relaxed">
