...
export default function PolitiqueRemboursementPage() {
  ...
  const sections = isFr ? [
    ...
    { title: "4. Comment demander un remboursement", content: "Étape 1 : Contactez-nous à support@happycattoys.ca avec votre numéro de commande, raison du retour et photos si défectueux. Étape 2 : Retournez le produit avec l'étiquette prépayée. Étape 3 : Remboursement traité sous 3-5 jours ouvrables." },
    ...
    { title: "10. Contact", content: "support@happycattoys.ca | 1-800-CAT-TOYS | Lun-Ven 9h-17h (EST). Réponse garantie sous 24h." },
  ] : [
    ...
    { title: "4. How to Request a Refund", content: "Step 1: Contact us at support@happycattoys.ca with your order number, return reason and photos if defective. Step 2: Return the product with the prepaid label. Step 3: Refund processed within 3-5 business days." },
    ...
    { title: "10. Contact", content: "support@happycattoys.ca | 1-800-CAT-TOYS | Mon-Fri 9am-5pm (EST). Guaranteed response within 24h." },
  ]
