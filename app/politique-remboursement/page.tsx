    ...
    <div className="min-h-screen bg-[#f5f2ed]">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg p-8 border border-border space-y-8">
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">1. Notre engagement</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">2. Période de remboursement</h2>
            <div className="bg-[#6b8e7b] bg-opacity-10 p-6 rounded-lg mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">3. Conditions de remboursement</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-foreground mb-2">✅ Produits éligibles</h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-foreground mb-2">❌ Produits non éligibles</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">4. Comment demander un remboursement</h2>
            <div className="space-y-4">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-medium text-foreground mb-3">📧 Étape 1 : Contactez-nous</h3>
                ...
                <p className="text-foreground font-medium mt-3">📧 support@happycattoys.ca</p>
              </div>

              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-medium text-foreground mb-3">📦 Étape 2 : Retournez le produit</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-medium text-foreground mb-3">💰 Étape 3 : Recevez votre remboursement</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">5. Types de remboursement</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border border-border rounded-lg p-6">
                <h3 className="text-lg font-medium text-foreground mb-3">💳 Remboursement complet</h3>
              ...
              <div className="border border-border rounded-lg p-6">
                <h3 className="text-lg font-medium text-foreground mb-3">💰 Remboursement partiel</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-1 text-sm">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">6. Frais de retour</h2>
            <div className="space-y-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">7. Échanges</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">9. Cas spéciaux</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-foreground mb-2">🚚 Colis endommagé à la livraison</h3>
                <p className="text-muted-foreground">
              ...
              <div>
                <h3 className="text-lg font-medium text-foreground mb-2">📦 Colis perdu</h3>
                <p className="text-muted-foreground">
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-foreground font-medium">Happy Cat Toys - Service Client</p>
              ...
              <p className="text-muted-foreground">🕒 Heures : Lun-Ven 9h-17h (EST)</p>
