        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a href="mailto:support@purrball.ca" className="border border-gray-300 text-gray-700 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colors text-sm">
